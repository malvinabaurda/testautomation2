...
public class Employee {
	 ...
	 * SimpleDateFormat format = new SimpleDateFormat("dd.MM.yyyy"); Date date1
	 * = null; Date date2 = null; try { date1 = format.parse(d1); date2 =
	 * format.parse(d2); } catch (Exception e) { e.printStackTrace(); } long
	 * difference = date1.getTime() - date2.getTime(); return difference / (24 *
	 * 60 * 60 * 1000); }
	 */
